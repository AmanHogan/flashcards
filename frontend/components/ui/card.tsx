...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card-description" className={cn("mb-2 text-sm text-muted-foreground", className)} {...props} />
}
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div data-slot="card-content" className={cn("px-4 pb-4 group-data-[size=sm]/card:px-3", className)} {...props} />
  )
}
